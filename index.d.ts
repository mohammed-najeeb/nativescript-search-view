/**
 * Contains the SearchView class, which represents a standard search bar component.
 * @module "ui/search-bar"
 */ /** */

 import { View, Property, EventData, Color } from "tns-core-modules/ui/core/view";
 ...
 export class SearchView extends View {
     ...
     /**
      * Gets or sets the TextField background color of the SearchView component.
      */
     textFieldBackgroundColor: Color;
 
     /**
      * Gets or sets the TextField Hint color of the SearchView component.
      */
  ...
  */
 export const textProperty: Property<SearchView, string>;
 export const hintProperty: Property<SearchView, string>;
 
 /**
  * Gets or sets the TextField background color of the SearchView component.
  */
 export const textFieldBackgroundColorProperty: Property<SearchView, Color>;
 
 export const textFieldHintColorProperty: Property<SearchView, Color>;
